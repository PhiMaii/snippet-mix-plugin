export function getIconSVG(
  ...
  return `<?xml version="1.0" encoding="utf-8"?>
        ...
        <text style="fill: rgb(255, 255, 255); font-family: Arial, sans-serif; font-size: 65px; font-weight: 700; text-anchor: end; white-space: pre;" x="462.898" y="487.796">${channels || 0} CH</text>
        <text style="fill: rgb(255, 255, 255); font-family: Arial, sans-serif; font-size: 65px; font-weight: 700; white-space: pre;" x="51.392" y="488.675">ID ${id || "NaN"}</text>
